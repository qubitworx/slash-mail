...
import { Check, Trash } from "ui/icons";
        ...
        <div className="relative">
            ...
            {isOpen && (
                <form
                    ...
                    className="fixed top-full z-[99999] mt-1 flex w-60 overflow-hidden rounded border border-stone-200 bg-white-fill p-1 shadow-xl animate-in fade-in slide-in-from-top-1"
                >
                    <input
                        ref={inputRef}
                        type="text"
